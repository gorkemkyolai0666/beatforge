...
const demoAudit: AuditEntry[] = [
  { id: '1', action: 'update', entity: 'BTF-142 Ödeme API entegrasyonu', entityType: 'issue', user: { name: 'Ayşe Kaya', email: 'ayse@beatforge.com.tr' }, ipAddress: '185.**.**.42', createdAt: new Date().toISOString() },
  { id: '2', action: 'create', entity: 'Sprint 12 — Ödeme Modülü', entityType: 'sprint', user: { name: 'Elif Öztürk', email: 'elif@beatforge.com.tr' }, ipAddress: '176.**.**.18', createdAt: new Date(Date.now() - 3600000).toISOString() },
  { id: '3', action: 'login', entity: 'Oturum açma', entityType: 'auth', user: { name: 'Mehmet Demir', email: 'mehmet@beatforge.com.tr' }, ipAddress: '78.**.**.91', createdAt: new Date(Date.now() - 7200000).toISOString() },
  { id: '4', action: 'delete', entity: 'BTF-128 Eski test görevi', entityType: 'issue', user: { name: 'Burak Şahin', email: 'burak@beatforge.com.tr' }, ipAddress: '185.**.**.42', createdAt: new Date(Date.now() - 86400000).toISOString() },
  { id: '5', action: 'export', entity: 'Sprint 11 raporu', entityType: 'report', user: { name: 'Ayşe Kaya', email: 'ayse@beatforge.com.tr' }, ipAddress: '185.**.**.42', createdAt: new Date(Date.now() - 172800000).toISOString() },
];
...
export default function AuditPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 rounded-lg border border-emerald/30 bg-emerald/5 p-4">
        <Shield className="mt-0.5 h-5 w-5 shrink-0 text-emerald-light" />
