...
const demoTeam: TeamMember[] = [
  { id: '1', name: 'Ayşe Kaya', email: 'ayse@beatforge.com.tr', role: 'product_owner', activeIssues: 4 },
  { id: '2', name: 'Mehmet Demir', email: 'mehmet@beatforge.com.tr', role: 'developer', activeIssues: 6 },
  { id: '3', name: 'Zeynep Arslan', email: 'zeynep@beatforge.com.tr', role: 'developer', activeIssues: 5 },
  { id: '4', name: 'Can Yılmaz', email: 'can@beatforge.com.tr', role: 'developer', activeIssues: 3 },
  { id: '5', name: 'Elif Öztürk', email: 'elif@beatforge.com.tr', role: 'scrum_master', activeIssues: 2 },
  { id: '6', name: 'Burak Şahin', email: 'burak@beatforge.com.tr', role: 'admin', activeIssues: 1 },
];
          ...
          {members.map((m) => (
            <div key={m.id} className="surface-card p-5">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-emerald/15 font-display text-lg font-bold text-emerald-light">
