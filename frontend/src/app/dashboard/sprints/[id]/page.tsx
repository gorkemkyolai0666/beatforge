...
const demoSprint: SprintDetail = {
  ...
  remainingPoints: 14,
  issues: [
    { id: '1', key: 'BTF-142', title: 'Ödeme API entegrasyonu', status: 'in_progress', storyPoints: 8 },
    { id: '2', key: 'BTF-143', title: 'Webhook retry mekanizması', status: 'todo', storyPoints: 5 },
    { id: '3', key: 'BTF-136', title: 'Dashboard istatistikleri', status: 'in_review', storyPoints: 5 },
    { id: '4', key: 'BTF-135', title: 'Proje iskelet kurulumu', status: 'done', storyPoints: 3 },
  ],
};
              ...
              {burndown.length === 0 ? (
                ...
                <div className="space-y-4">
                    ...
                    {burndown.map((point) => (
                      <div key={point.date} className="flex flex-1 flex-col items-center gap-1">
                        <div className="relative flex w-full items-end justify-center gap-0.5" style={{ height: 120 }}>
                          ...
                          <div className="w-2 rounded-t bg-emerald" style={{ height: `${(point.actual / maxPoints) * 100}%` }} title={`Gerçek: ${point.actual}`} />
                        </div>
                  ...
                  <div className="flex gap-4 text-xs text-muted-foreground">
                    ...
                    <span className="flex items-center gap-1"><span className="h-2 w-2 rounded bg-emerald" /> Gerçek</span>
                  </div>
                </div>
              )}
            </CardContent>
