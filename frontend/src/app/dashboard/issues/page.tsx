...
const demoIssues: Issue[] = [
  { id: '1', key: 'BTF-142', title: 'Ödeme API entegrasyonu', type: 'story', status: 'in_progress', priority: 'high', storyPoints: 8, assignee: { name: 'Mehmet D.' }, board: { name: 'Dosya Sürümü Geliştirme' } },
  { id: '2', key: 'BTF-143', title: 'Webhook retry mekanizması', type: 'task', status: 'todo', priority: 'medium', storyPoints: 5, assignee: { name: 'Can Y.' }, board: { name: 'Dosya Sürümü Geliştirme' } },
  { id: '3', key: 'BTF-138', title: 'JWT auth middleware', type: 'task', status: 'in_progress', priority: 'critical', storyPoints: 5, assignee: { name: 'Can Y.' }, board: { name: 'Altyapı & DevOps' } },
  { id: '4', key: 'BTF-136', title: 'Dashboard istatistikleri', type: 'story', status: 'in_review', priority: 'medium', storyPoints: 5, assignee: { name: 'Ayşe K.' }, board: { name: 'Dosya Sürümü Geliştirme' } },
  { id: '5', key: 'BTF-130', title: 'Login sayfası responsive düzeltme', type: 'bug', status: 'done', priority: 'low', storyPoints: 2, assignee: { name: 'Zeynep A.' }, board: { name: 'Tasarım Sistemi' } },
];
      ...
      {!loading && filtered.length > 0 && (
        <DataTable
          columns={[
            ...
            { key: 'board', header: 'Mesaj', render: (r) => r.board?.name ?? '—' },
          ]}
          data={filtered}
          pageSize={15}
        />
