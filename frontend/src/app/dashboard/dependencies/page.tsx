...
const demoDependencies: Dependency[] = [
  { id: '1', sourceIssue: { key: 'BTF-142', title: 'Pazarlama Mesajsi playlist cohesion cascade — BTF-101', board: { name: 'Pazarlama Mesajsi' } }, targetIssue: { key: 'BTF-138', title: 'Q2 Kampanya Dosyası v3', board: { name: 'Mühendislik Mesajsi' } }, type: 'blocked_by', isCriticalPath: true },
  { id: '2', sourceIssue: { key: 'BTF-143', title: 'Mühendislik Mesajsi blast-radius riski — BTF-102', board: { name: 'Mühendislik Mesajsi' } }, targetIssue: { key: 'BTF-142', title: 'Pazarlama Mesajsi playlist cohesion cascade — BTF-101', board: { name: 'Pazarlama Mesajsi' } }, type: 'blocked_by', isCriticalPath: true },
  { id: '3', sourceIssue: { key: 'BTF-136', title: 'Arşiv Mesajsi link revoke etkisi', board: { name: 'Arşiv Mesajsi' } }, targetIssue: { key: 'BTF-135', title: 'Yıllık Rapor Paylaşımı', board: { name: 'Mesaj Serileri' } }, type: 'relates_to', isCriticalPath: false },
  { id: '4', sourceIssue: { key: 'BTF-140', title: 'Ana Mesaj sync conflict', board: { name: 'Ana Mesaj' } }, targetIssue: { key: 'BTF-138', title: 'Q2 Kampanya Dosyası v3', board: { name: 'Mühendislik Mesajsi' } }, type: 'blocked_by', isCriticalPath: false },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="font-display text-3xl font-bold">Playlist Cohesion Cascade Radarı</h1>
          <p className="text-muted-foreground">Cross-SKU paylaşım ilişkileri ve etki playlist cohesion cascade</p>
        </div>
