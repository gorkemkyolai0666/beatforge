...
const navItems = [
  { href: "/dashboard", label: "Parçalarim", icon: FileText },
    ...
    <div className="flex min-h-screen bg-background">
      <aside className="hidden w-60 shrink-0 flex-col border-r border-border bg-card lg:flex">
        <div className="border-b border-border p-5">
          <Link href="/dashboard" className="flex items-center gap-3">
            ...
            <div>
              <div className="font-display text-base font-bold text-foreground">BeatForge</div>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-14 items-center justify-between border-b border-border bg-card/80 px-4 backdrop-blur-md lg:hidden">
          <Link href="/dashboard" className="font-display font-bold text-foreground">BeatForge</Link>
